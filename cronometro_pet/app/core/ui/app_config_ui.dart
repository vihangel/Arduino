...
class AppConfigUI {
  AppConfigUI._();
  static const MaterialColor _primarySwatch = MaterialColor(0XFFFF7272, {
    50: Color(0XFFff7272),
  ...
  static final ThemeData theme = ThemeData(
    ...
    primaryColorLight: const Color(0XFFFF7272),
    inputDecorationTheme: InputDecorationTheme(
      suffixIconColor: Color(0XFFFF7272),
      prefixIconColor: Color(0XFFFF7272),
